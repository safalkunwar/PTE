...
import {
  ...
  RefreshCw, Trash2, Eye, Edit, CheckCircle,
  Zap, Search, ArrowLeft,
} from "lucide-react";
              ...
              <Card className="bg-slate-700 border-slate-600">
                ...
                <CardContent className="space-y-4">
                  {healthLoading ? (
                    ...
                    <div className="space-y-3">
                      {systemHealth.services.map((service: { name: string; uptime: string; status: string }, i: number) => (
            ...
            <TabsContent value="users" className="space-y-4">
              <Card className="bg-slate-700 border-slate-600">
                ...
                <CardContent className="space-y-4">
                  ...
                  {statsLoading ? (
                    <LoadingSkeleton />
                  ) : systemStats && (systemStats.totalUsers > 0 || systemStats.activeUsers > 0) ? (
              ...
              <Card className="bg-slate-700 border-slate-600">
                ...
                <CardContent>
                  {logsLoading ? (
                    ...
                    <div className="space-y-2">
                      {logs.map((log: { action: string; userName: string; target: string; status: string; details: string; timestamp: string | Date }, i: number) => (
              ...
              <Card className="bg-slate-700 border-slate-600">
                ...
                <CardContent>
                  {alertsLoading ? (
                    ...
                    <div className="space-y-3">
                      {alerts.map((alert: { severity: string; title: string; message: string; timestamp: string }, i: number) => (
                        <div
                          key={i}
